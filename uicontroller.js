function updateUI() {
    ...
    document.getElementById('my-money').innerText = gameState.myMoney;
    document.getElementById('intimacy').innerText = gameState.intimacy;
    document.getElementById('dh-esteem').innerText = gameState.dhEsteem;
    ...
    document.getElementById('speaker-title').innerText = `${year}년 대기 중 · ${title}`;
